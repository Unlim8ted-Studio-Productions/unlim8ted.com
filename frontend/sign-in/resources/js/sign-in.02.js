...
function getRedirectTarget() {
  ...
  try {
    // Allow relative or absolute URLs, but enforce same-origin
...
function setMode(createMode) {
  ...
  document.getElementById("form-mode").textContent = createMode
    ? "Create Account"
    : "Sign In";
  document.getElementById("form-submit").textContent = createMode
    ? "Create Account"
    : "Sign In";
